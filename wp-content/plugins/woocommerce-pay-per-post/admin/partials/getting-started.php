<div class="wrap about-wrap full-width-layout">
    <h1><?php esc_html_e( 'Getting Started with WooCommerce Pay Per Post', 'wc_pay_per_post' ); ?></h1>
    ...
    <div class="feature-section is-wide has-2-columns is-wider-left">
        <div class="column is-vertically-aligned-center">
            ...
            <p>
				<?php _e( 'In your page or post edit screen, you will see a Pay Per post section which will allow you to search for your product that you want to have users purchase to view the content of the page.' ); ?>
            </p>
        </div>
        <div class="column">
            <div class="inline-svg aligncenter">
