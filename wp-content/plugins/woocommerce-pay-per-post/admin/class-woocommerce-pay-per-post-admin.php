...
class Woocommerce_Pay_Per_Post_Admin
{
    ...
    public function add_plugin_options()
    {
        ...
        add_submenu_page(
            WC_PPP_SLUG,
            'Getting Started with WooCommerce Pay Per Post',
            'Getting Started',
            'manage_options',
        ...
        add_submenu_page(
            WC_PPP_SLUG,
            'WooCommerce Pay Per Post Documentation',
            'Documentation',
            'manage_options',
            WC_PPP_SLUG . '-help',
    ...
    public function save_meta_box( $post_id )
    {
        ...
        $_show_warnings = 0;
        Woocommerce_Pay_Per_Post_Helper::logger( 'Saving Meta Box Data ', $_POST );
        // Save the product_id's associated with page/post.
        
        if ( isset( $_POST[WC_PPP_SLUG . '_product_ids'] ) ) {
            update_post_meta( $post_id, WC_PPP_SLUG . '_product_ids', $_POST[WC_PPP_SLUG . '_product_ids'] );
        } else {
            update_post_meta( $post_id, WC_PPP_SLUG . '_product_ids', '' );
        }
    ...
    {
        $columns[WC_PPP_SLUG . '_protected'] = 'Pay Per Post';
        return $columns;
    }
