...
Sell Pages/Posts through WooCommerce 2.6+ quickly and easily. Tested up to WooCommerce Version 3.9.x

== Description ==
Quickly and easily sell access to pages, posts and custom post types through WooCommerce with WooCommerce Pay Per Post.  I originally created this plugin because I looked everywhere and I couldn't find a plugin already out there, free or premium, that would do the simple fact of selling access to a particular page or post through WooCommerce.  So I decided to write my own.
...
- **Step 3** Associate your product with your page using the WooCommerce Pay Per Post meta box.
...
2. WooCommerce Pay Per Post meta box, including premium features.
3. Protected Page
...
= 2.4.15 =
* Minor update to add more filters and security fix.